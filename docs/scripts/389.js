...
(self.webpackChunk = self.webpackChunk || []).push([
  ...
  {
    9389: (e, n, a) => {
      a.d(n, { getGettingStartedMarkup: () => b });
      const t = a.p + '../../lib/images/editCopyPasteDelete.gif',
        o = a.p + '../../lib/images/changeTemplate.gif',
        i = a.p + '../../lib/images/toggleRequiredCols.gif',
        l = a.p + '../../lib/images/doubleClickHeaders.gif',
        s = a.p + '../../lib/images/selectingVals.gif',
        r = a.p + '../../lib/images/validatingCells.gif',
        c = a.p + '../../lib/images/showRows.gif',
        d = a.p + '../../lib/images/showSection.gif',
        u = a.p + '../../lib/images/jumpToColumn.gif',
        p = a.p + '../../lib/images/fillColumn.gif',
        m = a.p + '../../lib/images/exportingFiles.gif',
        g = a.p + '../../lib/images/provenance.gif',
        h = a.p + '../../lib/images/moreInfo.gif',
        f = a.p + '../../lib/images/versionUpdate.gif';
      var v = a(4782);
      const y = [
        {
          image: t,

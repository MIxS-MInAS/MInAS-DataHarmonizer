'use strict';
(this.webpackChunkschemas = this.webpackChunkschemas || []).push([
  [960],
  {
    960: (e, t, o) => {
        ...
        BioSample: {
          ...
          method: function (e) {
            const t = new Map([
              ...
              o = e.getFields(e.table),
              a = e.getFieldNameMap(o);
            e.getHeaderMap(t, o, 'BIOSAMPLE');
            const s = [[...t.keys()]];
            for (const _ of e.getTrimmedData(e.hot)) {
              const n = [];
              for (const [s, i] of t) {
                const t = e.getMappedField(s, _, i, o, a, ':', 'BIOSAMPLE');
                n.push(t);
              }
              s.push(n);
            }
        ...
        GISAID: {
          ...
          method: function (e) {
            const t = [
                ...
                ['Assembly method', []],
                ['Depth of coverage', ['depth_of_coverage_value']],
                ['Originating lab', []],
                ['Address', ['sample_collector_contact_address']],
                ['Sample ID given by the sample provider', []],
                ['Submitting lab', []],
                ['Address', ['sequence_submitter_contact_address']],
                [
              ...
              o = e.getFields(e.table),
              a = e.getFieldNameMap(o);
            e.getHeaderMap(t, o, 'GISAID');
            const s = [Array.from(t, (e) => e[0])];
            for (const _ of e.getTrimmedData(e.hot)) {
              const e = [];
              for (const [s] of t.entries()) {
                ...
                for (const e of i) {
                  ...
                  if (!s) continue;
                  const n = o[t],
                    l = s.toLowerCase().trim();
                  if ('specimen processing' === n.fieldName) {
                    if (!l.split(';').includes('virus passage')) continue;
                    s = 'Virus passage';
                  }
                  if (
                    n.dataStatus &&
                    n.dataStatus.map((e) => e.toLowerCase().trim()).includes(l)
                  ) {
                    if (i.length > 1) continue;
                    s = 'Unknown';
                  }
                  'passage number' === n.fieldName &&
                    (s = 'passage number ' + s),
                    c.push(s);
                }
                'Assembly method' === n
        ...
        'NML LIMS': {
          ...
          method: function (e) {
            const t = new Map([
                ...
                ['PH_DEHOSTING_METHOD', []],
                ['PH_CONSENSUS_SEQUENCE', []],
                ['PH_CONSENSUS_SEQUENCE_VERSION', []],
              ...
              o = e.getFields(e.table),
              a = e.getFieldNameMap(o),
              s = e.getFieldTitleMap(o);
            e.getHeaderMap(t, o, 'NML_LIMS');
            const _ = [[...t.keys()]],
              n = new Map([
            ...
            for (const c of e.getTrimmedData(e.hot)) {
              const l = [];
              for (const [_, r] of t) {
                if ('HC_CURRENT_ID' === _) {
                  l.push('Monkeypox virus');
                  continue;
                }
                if ('VE_SYMP_AVAIL' === _) {
                  const e = c[s['signs and symptoms']] || '';
                  l.push(e ? 'Y' : 'N');
                  continue;
                }
                if ('HC_COLLECT_DATE' === _) {
                  let t = c[s['sample collection date']] || '';
                  const o = c[s['sample collection date precision']];
                  l.push(e.setDateChange(o, t, '01'));
                  continue;
                }
                if ('PH_SPECIMEN_SOURCE' === _) {
                  let e = '';
                  for (const t of [
                    'host (scientific name)',
                    'host (common name)',
                    ...
                    if (o && !i.has(o)) {
                      if (
                        'host (scientific name)' === t ||
                        'host (common name)' === t
                      ) {
                        e =
                          'Homo sapiens' === o || 'Human' === o
                            ? 'Human'
                            : 'ANIMAL';
                        break;
                      }
                      if (
                        'environmental material' === t ||
                        'environmental site' === t
                      ) {
                        e = 'ENVIRO';
                        break;
                      }
                ...
                let t = e.getMappedField(_, c, r, o, a, ';', 'NML_LIMS'),
                  S = t.split(';');
                if (
                  ((S = S.map((t) => e.fixNullOptionCase(t.trim(), n))),
                  S.length > 1)
                ) {
                  let e = new Set(S);
                  i.forEach(Set.prototype.delete, e),
                    0 == e.size && (e = new Set(S)),
                    (S = [...e]);
                }
                (t = S.join(';')), l.push(t);
              }
